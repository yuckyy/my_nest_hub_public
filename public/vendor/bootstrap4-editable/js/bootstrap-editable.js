...
(function ($) {
    ...
    var Combodate = function (element, options) {
        ...
        this.options.template = 'MMM / D / YYYY'; //i763
        this.init();
     };
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        render: function () {
            ...
            if($.fn.editableform.engine === 'bs4') {
                this.$input.siblings().find('select').addClass('form-control').addClass('form-control-sm');
            }
...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      ...
      '</button>'+
      '<button type="button" class="btn btn-cancel btn-sm editable-cancel">'+
