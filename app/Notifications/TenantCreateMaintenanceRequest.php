...
class TenantCreateMaintenanceRequest extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return $mail
            ->subject("New Maintenance Request has been created by " . $this->tenant->fullName())
            ->markdown('smtp.notifications.tenant_create_maintenance_request', [
