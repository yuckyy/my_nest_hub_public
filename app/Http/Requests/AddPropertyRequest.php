...
class AddPropertyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return  [
            ...
            'state' => 'required|integer|min:1|max:255',
            ...
            'units.*.bedrooms' => 'required|integer|min:1',
            'units.*.full_bathrooms' => 'required|integer|min:0',
            'units.*.half_bathrooms' => 'required|integer|min:0',
