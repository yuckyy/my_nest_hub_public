...
@section('content')
    ...
    <div class="container-fluid pb-4">
        ...
        <div class="container-fluid">
            <h1 class="h2 pt-4 pb-2">Identity Verification <span style="vertical-align: top"
                                                                 class="badge badge-success">Verified</span></h1>
            @if (session('error'))
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="inRowComment">
                        <i class="fal fa-info-circle"></i> This will unlink and delete all your ePatRents finance
                        accounts allowed receiving ACH payments. <span class="text-danger">You may not be able to verify this user again. This operation cannot be undone.</span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body bg-light">
                    ...
                    <p>This will unlink and delete all your ePatRents finance accounts allowed receiving ACH payments.
                        <span class="text-danger">You may not be able to verify this user again. This operation cannot be undone.</span>
                    </p>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <i class="fal fa-times mr-1"></i> Keep Verified
                    </button>
