...
@section('content')
    <div class="container-fluid d-none d-md-block breadCrumbs">
        <a href="{{ route('dashboard') }}">Dashboard</a> > <a href="{{ route('profile/membership') }}">Membership</a> > <a href="#">Buy Addon</a>
    </div>
    <div class="container pb-4">
        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-12">
                <div class="container">
                    <div class="pt-4 pb-3">
                        <h1 class="h2 text-center text-sm-left">Subscribe to {{ $addon->title }} Addon</h1>
                    </div>
                </div>
                <div class="container">
                    <form class="needs-validation finance-form" method="post" action="{{ route('profile/addon-subscribe') }}">
                        @csrf
                        ...
                        <div class="card propertyForm">
                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="h4">Your total: $<span id="total">{{ $addon->price }}</span></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                            ...
                            <div class="card-footer text-muted">
                                <a href="{{ route('profile/membership') }}" class="btn btn-cancel btn-sm mr-3">
...
@section('scripts')
    ...
    <script>
        ...
        $('#apply-code').click(function(){
            ...
            $.post("{{ route('apply-code') }}", { code: code,total:{{ $addon->price }} }, function (data) {
                if (data.error) {
                    success.html('');
