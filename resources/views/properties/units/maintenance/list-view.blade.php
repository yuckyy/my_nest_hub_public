    ...
    <div class="container-fluid">
        ...
        <div class="filterMaintenanceBox container-fluid">
            ...
            <div class="d-block d-sm-block d-xl-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3">
                ...
                <form method="get" id="maintenanceFilterForm" action="{{ route('properties/units/maintenance/list-view',['unit' => $unit]) }}">
                    <div class="filterToolbar btn-toolbar mb-2 mb-md-0">
                        <a href="{{ route('properties/units/maintenance',['unit' => $unit]) }}" data-toggle="tooltip" data-placement="top" title="" class="btn btn-sm btn-light mr-3 buttonWithBigIcon" type="button" data-original-title="Panel view">
...
{{--                        </div>--}}
                        ...
                        <a href="{{ route('properties/units/maintenance/list-view',['unit' => $unit]) }}" class="btn btn-sm btn-primary mr-4 d-none d-lg-inline-block"  data-toggle="tooltip" data-placement="top" title="Reset Filters">
                ...
                @else
                    ...
                    <a href="{{ route('properties/units/maintenance',['unit' => $unit]) }}" class="btn btn-cancel btn-sm"><i class="fal fa-times mr-1"></i> Exit Archive</a>
                @endif
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::user()->isLandlord() || Auth::user()->isPropManager())
                                        ...
                                        @endif
                                    @endif
                                    <span data-toggle="modal" class="vacant-check-click"data-target="#detailsModal" data-category="{{ $maintenanceRequest->expense_type }}" data-property-address="{{ $maintenanceRequest->property_address }}" data-vacant="{{ $maintenanceRequest->deleted_at }}"  data-record-id="{{ $maintenanceRequest->id }}" data-color="{{ $maintenanceRequest->color() }}" data-record-title="{{ '#' . $maintenanceRequest->id . ", " . date('m/d/Y', strtotime($maintenanceRequest->created_at)) }}">
