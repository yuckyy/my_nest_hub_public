            ...
            <div class="modal-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-5">
                            <h7 class="modal-title " >Property Address: <span class="property-address"></span></h7><br>
                            <h8 class="modal-title detailsCategoryTitle" id="detailsCategoryTitle">Expense Type : <span class="categoryTitle"></span></h8>
                        </div>
                        <div class="col-1">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="row pb-2">
                                        ...
                                        <div class="col-md-9 selectParent">
                                            ...
                                            <div class="selectpickerBox border rounded">
                                                <select id="newTicketModalProperty" disabled name="property" class="selectpicker form-control form-control-sm" data-live-search="true" required>
                                                        ...
                                                        @foreach( $allcategory as $category)
                                                            ...
                                                            @else
                                                                <li><a class="dropdown-item" disabled > {{$category->name}}    ></a>
                                                                    <ul class="submenu dropdown-menu dropdown-menu ulsubdropstyle">
                                                                        @foreach( $allsubcategory as $subcategory)
                                                                            @if($subcategory->pid === $category->id)
                                                                                <li><a class="dropdown-item dropdown-item-click dropdown-item-click"data-pid="{{$subcategory->pid}}" data-category="{{$subcategory->id}}"  > {{$subcategory->name}}</a></li>
                                                                            @endif
                                                                        @endforeach
                                                                    </ul>
                                                                </li>
