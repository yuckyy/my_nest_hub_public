        ...
        @if (Auth::user()->isTenant() || (count(Auth::user()->properties) > 0))
            ...
            <div class="filterMaintenanceBox container-fluid">
                ...
                <div class="d-block d-sm-block d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3">
                    ...
                    <form method="get" id="maintenanceFilterForm" action="{{ route('maintenance') }}">
                        <div class="filterToolbar btn-toolbar mb-2 mb-md-0">
                            <a href="{{ route('maintenance/list-view') }}" data-toggle="tooltip" data-placement="top" title="" class="btn btn-sm btn-light mr-3 buttonWithBigIcon" type="button" data-original-title="List view">
                            ...
                            <a href="{{ route('maintenance') }}" class="btn btn-sm btn-primary mr-4 d-none d-lg-inline-block" data-toggle="tooltip" data-placement="top" title="Reset Filters">
                    ...
                    <div class="col-md-4">
                        <div class="card maintenancePad">
                            <div class="card-header bg-white">
                                ...
                                <a id="viewAllButtonResolved" style="margin: -0.3rem auto;" class="viewAllLink btn btn-sm btn-primary float-sm-right" href="{{ route('maintenance/list-view', ['status_id' => 1 ]) }}">View All</a>
                            </div>
    ...
    <script>
        jQuery( document ).ready(function($) {
            ...
            $('#newTicketModalSumbit').on('click', function (e) {
                ...
                const ServicePro = $('#newTicketModalServicePro').val();
                ...
                form_data.append('service_pro', ServicePro);
