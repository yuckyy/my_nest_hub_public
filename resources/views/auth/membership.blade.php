...
@section('content')
    ...
    <div class="container-fluid pb-4">
        <div class="container-fluid unitFormContainer">
            <div class="row">
                <div class="profileNavTabsLeftContent col-md-9 mx-auto">
                    <div class="card propertyForm propertyFormGeneralInfo">
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                        <div class="card-body bg-light">
                            <h1 class="h4 pb-1 pl-1">Select your Membership
                                <a href="#" onclick="event.preventDefault();$('#logout-form').submit();"
                                   class="btn btn-link btn-sm float-right text-muted">
                                    Logout <i class="fal fa-sign-out text-muted ml-1"></i>
                                </a>
                            </h1>
                            <div class="pl-1 pb-2">
                                ...
                                @foreach ($plansToShow as $plan)
                                    <div class="col-xl-3 col-md-6 block pb-4">
                                        <div class="pricing">
                                            ...
                                            @if ($plan->price)
                                                <a href="{{ route('/subscribe',['plan_id' => $plan->id]) }}"
                            ...
                            {{--
                            @if (count($addons) != 0)
                            <h2 class="h4 pt-3 pb-1 pl-1">Addons</h2>
                            <div class="row">
