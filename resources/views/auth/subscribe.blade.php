                    ...
                    <form class="needs-validation finance-form" method="post" action="{{ route('profile/create-subscription') }}">
                        ...
                        <div class="card propertyForm">
                            ...
                            <div class="card-body bg-light">
                                ...
                                <div class="collapse multi-collapse show" id="addFinanceAccountContent">
                            ...
                            <div class="card-footer text-muted">
                                <a href="{{ route('registration/membership') }}" class="btn btn-cancel btn-sm mr-3">
...
@section('scripts')
    ...
    <script>
        ...
        $('#apply-code').click(function(){
            ...
            $.post("{{ route('apply-code') }}", {"_token": '{{ csrf_token() }}', code: code,total:{{ $plan->price }} }, function (data) {
                if (data.error) {
                    success.html('');
