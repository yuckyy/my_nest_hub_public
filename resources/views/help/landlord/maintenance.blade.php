        ...
        <div class="row">
            <div class="helpNavColumn col-md-3 col-lg-2 border-right">
                ...
                <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="active mt-2" id="tab-1" data-toggle="pill" href="#content-1" role="tab" aria-controls="content-1" aria-selected="true">Add Maintenance Request</a>
                    <!--<a class="" id="tab-2" data-toggle="pill" href="#content-2" role="tab" aria-controls="content-2" aria-selected="false">Expenses 2</a>
                    <!--<a class="" id="tab-3" data-toggle="pill" href="#content-3" role="tab" aria-controls="content-3" aria-selected="false">Expenses 3</a>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="content-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="pb-3 text-center text-sm-left">
                            <h1 class="h2">Add Maintenance Request</h1>
                        </div>
                        <p>
