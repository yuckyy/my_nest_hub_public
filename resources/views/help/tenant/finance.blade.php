        ...
        <div class="row">
            <div class="helpNavColumn col-md-3 col-lg-2 border-right">
                ...
                <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="active mt-2" id="tab-1" data-toggle="pill" href="#content-1" role="tab" aria-controls="content-1" aria-selected="true">Set Up Recurring Payments</a>
                    <a class="" id="tab-2" data-toggle="pill" href="#content-2" role="tab" aria-controls="content-2" aria-selected="false">Make a “one-time” payment</a>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="content-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="pb-3 text-center text-sm-left">
                            <h1 class="h2">Set Up Recurring Payments</h1>
                        </div>
                        <!--
                        <p>
                    ...
                    <div class="tab-pane fade" id="content-2" role="tabpanel" aria-labelledby="tab-2">
                        <div class="pb-3 text-center text-sm-left">
                            <h1 class="h2">Make a “one-time” payment</h1>
                        </div>
                        <!--
                        <p>
